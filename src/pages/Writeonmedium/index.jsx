          ...
          <div className="flex flex-col gap-8 items-center justify-start w-full">
            ...
            <div className="flex md:flex-col flex-row gap-6 items-start justify-start max-w-[1376px] mx-auto md:px-5 w-full">
              <div className="flex md:flex-1 flex-col gap-6 items-center justify-start w-[67%] md:w-full">
                <Text
                  className="border border-blue_gray-100 border-solid h-[90px] max-w-[909px] md:max-w-full pl-8 pr-[35px] sm:px-5 py-5 rounded-lg sm:text-4xl md:text-[38px] text-[40px] text-blue_gray-300 w-full"
                ...
                <div className="border border-blue_gray-100 border-solid flex flex-col h-[753px] md:h-auto items-start justify-start max-w-[909px] p-8 sm:px-5 rounded-lg w-full">
                  <Text
                    ...
                    size="txtGilroyMedium20Bluegray300"
                  >
                    Tell your story...
                  </Text>
                </div>
              ...
              <div className="flex md:flex-1 flex-col gap-6 items-center justify-start w-[33%] md:w-full">
                <div className="flex flex-col gap-2 items-start justify-start w-auto sm:w-full">
                  ...
                  <TextArea
                    className="bg-transparent border border-blue_gray-100 border-solid font-medium gap-5 h-[251px] p-6 sm:px-5 rounded-lg placeholder:text-blue_gray-300 text-blue_gray-300 text-left text-xl w-[443px]"
                    name="frame9883"
                ...
                <div className="flex flex-col gap-2 items-start justify-start w-auto sm:w-full">
                  ...
                  <Input
                    ...
                    className="font-medium md:h-auto p-0 placeholder:text-blue_gray-300 sm:h-auto text-left text-xl w-full"
                ...
                <Input
                  ...
                  className="font-medium p-0 placeholder:text-blue_gray-300 text-center text-lg w-full"
                  wrapClassName="border border-blue_gray-100 border-solid flex w-[443px] sm:w-full"
                  suffix={
                    <Img
